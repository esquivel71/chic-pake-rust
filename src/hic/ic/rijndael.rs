...
impl Rijndael {
    ...
    #[inline(always)]
    pub fn encrypt(&self, source: &[u8]) -> Result<[u8;32], Errors> {
    ...
    #[inline(always)]
    pub fn decrypt(&self, block_cipher: &[u8]) -> Result<[u8;32], Errors> {
        require!(
...
fn push4(dst: &mut [u8;32], val1: u8, val2: u8, val3: u8, val4: u8, start_i: &usize) {
    dst[*start_i] = val1;
    dst[*start_i + 1] = val2;
    dst[*start_i + 2] = val3;
    dst[*start_i + 3] = val4;
